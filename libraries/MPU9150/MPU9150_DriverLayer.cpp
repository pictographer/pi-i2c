...
#warning This compilation unit assumes AVR pgm_read_byte does something useful here
#define pgm_read_byte(a) uint8_t(42)
#endif
...
int mpu_init( struct int_param_s* int_param )
{
        ...
        else
        {
                ...
                {
#ifdef MPU_DEBUG
                        Serial.print( "Product ID read as 0 indicates device is either incompatible or an MPU3050" );
#endif
                        return -6;
                }
                else if( rev == 4 )
                {
#ifdef MPU_DEBUG
                        Serial.print( "Half sensitivity part found." );
#endif
                        st->chip_cfg.accel_half = 1;
                }
                else
...
#ifdef AK89xx_SECONDARY
#ifdef MPU_DEBUG
        Serial.print( "Setting up compass" );
#endif
